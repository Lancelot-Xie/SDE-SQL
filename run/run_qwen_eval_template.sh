...
eval_path="${EVAL_PATH:-./data/dev.json}"
db_root_path="${DB_ROOT_PATH:-./data/dev_databases/}"
db_desc_path="${DB_DESC_PATH:-./data/database_schema_dev.json}"
match_content_path="${MATCH_CONTENT_PATH:-./data/match_content.json}"
engine="${ENGINE:-qwen-max}"
temperature="${TEMPERATURE:-0.3}"
try_num="${TRY_NUM:-3}"
data_output_path="${DATA_OUTPUT_PATH:-./exp_result/qwen_eval/}"
